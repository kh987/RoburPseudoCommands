...
## Cursor
Last completed action: Stable-артефакт dist/RoburPseudoCommands-0.8.0.tpm собран и верифицирован (2026-09-24; SHA-256 8714fd63…b2a8; 17 entries, About «Stable / 0.8.0», код идентичен host-проверенному rc.1) после подтверждённого APPLY RC → Stable
Next action: контрольная установка 0.8.0.tpm в Robur Genplan 16.0.62.12 (пользователь: About «Stable / 0.8.0» + базовый сценарий); затем release note (73_LIFECYCLE_GATES.md) и публикация GitHub Release — отдельными командами
