...
## Cursor
Last completed action: пользователь установил 0.8.0-rc.1.tpm в Robur Genplan 16.0.62.12 и прошёл все ручные сценарии без ошибок (host-сессия 2026-09-24); документация синхронизирована
Next action: отдельно запустить CHECK RC → Stable (73_LIFECYCLE_GATES.md; все ручные сценарии rc.1 пройдены, оценить актуальность evidence и отсутствие release blockers)
