...
Последний опубликованный релиз — [`v0.8.0`](https://github.com/kh987/RoburPseudoCommands/releases/tag/v0.8.0).
...
- Стабильная версия — `v0.8.0`, опубликована 2026-09-24.
...
- Последний опубликованный GitHub Release: [`v0.8.0`](https://github.com/kh987/RoburPseudoCommands/releases/tag/v0.8.0).
