...
- В `О плагине` для текущей сборки указано `0.7.0-rc.1`, а состояния QuickInput, Space-as-Enter и message filter соответствуют настройкам.
...
- Стадия: `RC`; разрешены только исправления release blockers.
