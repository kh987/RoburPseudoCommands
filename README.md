...
- Последний собранный TPM — `0.8.0-debug` (Stabilization-кандидат, частично проверен в Robur Genplan 16.0.62.12: установка, About, применение alias без перезапуска); сборка `0.8.0-rc.1` ещё не выполнялась; полный функциональный smoke выполнен для dev.9.
