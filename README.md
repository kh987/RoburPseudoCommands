...
- Последний собранный TPM — `0.8.0-rc.1` (2026-09-24: установлен и проверен пользователем в Robur Genplan 16.0.62.12); полный функциональный smoke-матрица выполнялась для dev.9; предыдущий кандидат `0.8.0-debug` частично проверен в host 2026-09-23.
