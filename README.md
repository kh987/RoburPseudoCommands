...
- Robur: поддерживается Robur 16.0. Проверено: Robur Genplan 16.0 (сборка 16.0.62.12) — полный smoke для `0.8.0-dev.9`; `0.8.0-rc.1` установлен и проверен пользователем 2026-09-24. Robur Genplan 16.0 для стабильной `v0.7.0`; ранние версии дополнительно проверялись в Robur Road 16.0 и учебной версии.
...
- Последний собранный TPM — `0.8.0-rc.1` (2026-09-24: установлен, все ручные сценарии пройдены без ошибок в Robur Genplan 16.0.62.12); полный функциональный smoke-матрица выполнялась для dev.9; предыдущий кандидат `0.8.0-debug` частично проверен в host 2026-09-23.
